...
namespace Catering.Infrastructure.Migrations
{
    ...
    [Migration("20250414193357_RemoveFirstAndLastNameForUser")]
    partial class RemoveFirstAndLastNameForUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catering.Infrastructure.Data.Models.Restaurant", b =>
                {
                    ...
                    b.Property<int>("WorkingTimeId")
                        .HasColumnType("int")
                        .HasComment("Working Time Schedule Identifier");
            ...
            modelBuilder.Entity("Catering.Infrastructure.Data.Models.WorkingDay", b =>
                {
                    ...
                    b.Property<int>("WorkingTimeId")
                        .HasColumnType("int")
                        .HasComment("Foreign key to the related WorkingTime schedule.");
            ...
            modelBuilder.Entity("Catering.Infrastructure.Data.Models.WorkingTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Working Time Identifier");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.HasKey("Id");

                    b.ToTable("WorkingTimes", t =>
                        {
                            t.HasComment("Represents the overall working time schedule for a restaurant.");
                        });
                });
            ...
            modelBuilder.Entity("Catering.Infrastructure.Data.Models.Restaurant", b =>
                {
                    ...
                    b.HasOne("Catering.Infrastructure.Data.Models.WorkingTime", "WorkingTime")
                        .WithMany()
